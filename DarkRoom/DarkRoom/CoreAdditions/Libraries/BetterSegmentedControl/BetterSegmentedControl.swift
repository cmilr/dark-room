...
@IBDesignable open class BetterSegmentedControl: UIControl {
    ...
    @IBInspectable public var cornerRadius: CGFloat {
        ...
        set {
            ...
            indicatorView.cornerRadius = newValue - itemInset
            segmentViews.forEach { $0.layer.cornerRadius = indicatorView.cornerRadius }
        }
    }
    /// The indicator view's background color
    @IBInspectable public var itemColor: UIColor? {
        get {
    ...
    @IBInspectable public var itemInset: CGFloat = 2.0 {
        didSet { setNeedsLayout() }
    }
    /// The indicator view's border width
    @IBInspectable public var itemBorderWidth: CGFloat {
        get {
    ...
    @IBInspectable public var itemBorderColor: UIColor? {
        get {
    ...
    private var totalInsetSize: CGFloat { return itemInset * 2.0 }
    ...
    private func elementFrame(forIndex index: UInt) -> CGRect {
        ...
        return CGRect(x: CGFloat(index) * elementWidth + itemInset,
                      y: itemInset,
                      width: elementWidth,
    ...
    @objc private func panned(_ gestureRecognizer: UIPanGestureRecognizer!) {
        ...
        case .changed:
            ...
            frame.origin.x = max(min(frame.origin.x, bounds.width - itemInset - frame.width), itemInset)
